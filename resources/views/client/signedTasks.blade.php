...
<div class="container">
    ...
    <div class="row">
        <h2 style="margin-bottom: 15px;">Confirmed Jobs:</h2>
    </div>
    <div class="row">
        <div class="col-md-12">
            <?php $a = 0;?>
                ...
                @if($job->client_id_fk == auth()->user()->id)
                    @foreach($ct as $t)
                        @if($t->task_id_fk == $job->id)
                            <div class="card">
                                <div class="card-header" style="background: darkgrey;">
                                    @if(Auth::check())
                                        ...
                                        <div class="col-md-11">
                                            @if(Auth::check())
                                                @if((auth()->user()->id == $job->client_id_fk))
                                                    ...
                                                    <br>
                                                    <br>
                                                    <span style="margin-left: 330px;">In order of completion of task, press this button.</span>
                                                    <a href="/client/{{$job->id}}/jkl" class="btn btn-success float-right">Task Completed</a>
                                                @endif
                                        </div>
                                    </div>
                                    <div class="row">
