...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <br>
            <div class="card">
                <div class="card-header" style="background: darkgrey;">{{ __('Register Yourself') }}</div>
                ...
                <div class="card-body" style="background: lightgrey;">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="dropdown-item" style="border:2px solid lightgrey; background: white;" name="user_type" value="user_type" ><option value="Tasker" style="color: green;">Tasker</option><option value="Client">Client</select>
                            </div>
                        </div>
